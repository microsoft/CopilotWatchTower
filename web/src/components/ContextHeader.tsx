...
import type { NavKey } from "./Sidebar";const TITLES: Record<NavKey, { title: string; subtitle: string }> = {
  ...
  conversationsDataverse: { title: "대화 탐색(Teams)", subtitle: "Dataverse에서 수집한 Copilot Studio 커스텀 에이전트의 Teams 대화 기록을 살폼봅니다." },
  ...
  consumption: { title: "파워플랫폼 크레딧", subtitle: "Copilot Studio 메시지·AI Builder 크레딧·Power Platform 요청 소비량을 추적합니다." },
  collectOverview: { title: "데이터 수집 개요", subtitle: "출처별로 어떤 데이터를 어떤 기술·권한으로 수집하는지와 제약·범위를 안내합니다." },
  collectConversation: { title: "대화 수집(API)", subtitle: "Graph API로 사용자 Copilot 대화를 수집·인덱싱합니다." },
  ...
  collectConsumption: { title: "파워플랫폼 크레딧 수집", subtitle: "PPAC 자동 로그인으로 메시지·AI Builder·API 요청 소비량 리포트를 내려받습니다." },
  collectTranscripts: { title: "대화 수집(Teams)", subtitle: "Dataverse 자동 로그인으로 Copilot Studio 커스텀 에이전트의 Teams 대화 기록을 수집합니다." },
  backupRestore: {
    title: "백업·복원",
